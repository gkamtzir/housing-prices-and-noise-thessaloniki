...
if __name__ == "__main__":
    ...
    run_name = create_run_name("random_forest", noise, area)
    ...
    experiment_details = {
        ...
        "artifact": "./data/properties_noise_50.parquet.gzip",
    ...
    # Run the experiment
    run_experiment(model, parameters, X, y, 50, 0.2, "random-forest",
